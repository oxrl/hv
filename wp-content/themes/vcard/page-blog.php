...
<?php if ($vcard_data['profile_link_enable'] == 1) { ?>
    ...
    <div class="item-cont clearfix">
        ...
        <div class="col535 fl-left">
            <?php 
                    ...
                    $posts_per_page = (isset($vcard_data['blog_posts_items_count'])) ? $vcard_data['blog_posts_items_count'] : '-1';
                    $args = array(
                        'post_type' => 'post',
                        'post_status' => 'publish',
                                ...
                                <div class="entry-photo">
                                    <div class="container">
                                            ...
                                            <div id="slides<?php echo $k; ?>" class="slides">
                                                    <?php
                                                    $i = 2;
													$posts_slideshow_number = (isset($vcard_data['posts_slideshow_number'])) ? $posts_slideshow_number : 1;
            ...
            <div id="pageination" class="clearfix">  
                <?php 
					...
					$posts_per_page = (isset($vcard_data['blog_posts_items_count'])) ? $vcard_data['blog_posts_items_count'] : '10';
