...
jQuery(document).ready(function($) {
	var deep_sky_blue = new Array();    deep_sky_blue['primary_color']='#53b7f9';
	var orange_red = new Array();    	orange_red['primary_color']='#ff3500';
	var green = new Array();    		green['primary_color']='#35bb2e';
	var ornage = new Array();    		ornage['primary_color']='#ff6800';
	var blue = new Array();    			blue['primary_color']='#197bbf';
	var yellow_green = new Array();    	yellow_green['primary_color']='#c7df2e';
	var brown = new Array();    		brown['primary_color']='#704f36';
	var tomato = new Array();    		tomato['primary_color']='#e35039';
	var orchid = new Array();    		orchid['primary_color']='#df5085';
	var sea_green = new Array();    	sea_green['primary_color']='#03ae91';
	var red = new Array();    			red['primary_color']='#ea3302';
	var medium_turquoise = new Array(); medium_turquoise['primary_color']='#27ccc0';
	var purple = new Array();    		purple['primary_color']='#976ad8';
	var gold = new Array();    			gold['primary_color']='#f9c100';

    // When the select box #base_color_scheme changes
    // of_update_color updates each of the color pickers
    $('#color_scheme').change(function() {
        colorscheme = $(this).val();
        if (colorscheme == 'Deep Sky Blue') { colorscheme = deep_sky_blue; }
        if (colorscheme == 'Orange Red') 	{ colorscheme = orange_red; }
		if (colorscheme == 'Green') 		{ colorscheme = green; }
		if (colorscheme == 'Orange') 		{ colorscheme = ornage; }		
        if (colorscheme == 'Blue') 			{ colorscheme = blue; }
        if (colorscheme == 'Yellow Green') 	{ colorscheme = yellow_green; }				
		if (colorscheme == 'Brown') 		{ colorscheme = brown; }
        if (colorscheme == 'Tomato') 		{ colorscheme = tomato; }
		if (colorscheme == 'Orchid') 		{ colorscheme = orchid; }
		if (colorscheme == 'Sea Green') 	{ colorscheme = sea_green; }
		if (colorscheme == 'Red') 			{ colorscheme = red; }
		if (colorscheme == 'Medium Turquoise') { colorscheme = medium_turquoise; }
		if (colorscheme == 'Purple') 		{ colorscheme = purple; }
		if (colorscheme == 'Gold') 			{ colorscheme = gold; }
