...
<section id="blog" class="item">
	<h2 class="item-title"><a href="<?php echo $rm_blog_page_link; ?>"><span class="title"><?php _e('my blog posts','vcard'); ?></span> <span class="icon-blog"></span></a></h2>
		</span> <span class="icon-blog"></span>
    </h2>
    <div class="item-cont clearfix">
        ...
        <div class="col535 fl-left">
            <?php 
                ...
                query_posts(array('posts_per_page' => $posts_per_page, 'paged' => $paged, 'post_type' => 'post', 'tag' => get_query_var('tag') ));
            ?>
            <?php if(have_posts()):?>
                ...
                ?>
                    <article class="entry-box">
                        <header class="entry-header">
                            ...
                            <?php $cat = get_the_category_list( ', ', '', get_the_ID() );?>
                            <div class="post-info">Posted by <?php the_author_posts_link(); if($cat):?> in <?php echo $cat;endif;?></div>
                        </header>
